...
<!--                 		<div class="login-form"> -->
                		...
                		<h3 style="text-align:center;">Logout</h3><br>
                	<div>	<img src="logout.png"></div>
                		<p style="text-align:center;">Do you want to logout</p>
                		<a href="Home.jsp" class="rent-btn" style="margin-left:80px; margin-right:15px;" onclick="return myFunction();">Yes</a>         <a href="ToHomeController?usertype=<%="AgencyOwner" %>" class="rent-btn">NO</a>

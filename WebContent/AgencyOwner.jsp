<%@ page import="java.util.ArrayList , beans.AgencyownerBean" %>
<!DOCTYPE html>
...
<!--                       <th>View</th> -->
                    ...
                    <%
                       ArrayList<AgencyownerBean> agencyownerList=null;
                       agencyownerList=(ArrayList<AgencyownerBean>)request.getAttribute("agencyOwnerList");
                       int count=0;
                      // out.println("Hello how are you");
                     //  for(AgencyBean ab:agencyList)
                       for(int i=0;i<=agencyownerList.size()-1;i++)
                       { count++;
                       AgencyownerBean cb=agencyownerList.get(i);
                    	   %>
                    	    <tr>
                             <td>
                    	   <%
                    	   
                    	  out.println(cb.getOwnerid());
                    	  %>
                    	  </td>
                    	  <td>
                    	    <%
                    	    out.println(cb.getFname());
                    	    %>
                    	  </td>
                    	    <td>
                    	     <%
                    	    out.println(cb.getLname());
                    	    %>
                    	  </td>
                    	   <td>
                    	   <%
                    	   ...
                    	   <td>
                    	   <%
                    	    out.println(cb.getPassword());
                    	    %>
                    	  </td>
                    	  <td>
                    	   <%
                    	    out.println(cb.getEmailid());
                    	    %>
                    	  </td>
                    	  <td>
                    	   <%
                    	    out.println(cb.getMobile());
                    	    %>
                    	  </td>
                    	  <td>
                    	   <%
                    	    out.println(cb.getAddressline1());
                    	    %>
                    	  </td>
                    	  
                    	  <td>
                    	   <%
                    	    out.println(cb.getStatus());
                    	  
                    	   AgencyownerBean agencyowner=agencyownerList.get(i);
                    	   
                    	   // request.setAttribute("agency",agencyList.get(i));
                    	    int x=10;
                    	   %>
                    	   </td>
<!--                     	   <td id="id1"><a href="#">View</a></td> -->
                           ...
                           <td id="id1"><a href="AgencyOwnerEditController?ownerid=<%=cb.getOwnerid()%>">Edit</a></td>
                           
                           
                           
                           
                           
                           <td id="id1"><a href="AgencyOwnerDeleteController?ownerid=<%=agencyowner.getOwnerid()%>">Delete</a></td>
                    <%	
                 //   out.print(ab.getAgencyname()+"ffffffffffffffffffffffffffffffffffffffffff");
//                       out.print("hello how are you:"+agencyList.get(i).getAgencyname());

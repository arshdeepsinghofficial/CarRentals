<%@page import="beans.CarbookingBean"%>
...
<!--                       <th>Status</th> -->
                   ...
                   <%
                       ArrayList<CarbookingBean> ordersList=null;
                   ordersList=(ArrayList<CarbookingBean>)request.getAttribute("ordersList");
                       int count=0;
                      // out.println("Hello how are you");
                     //  for(AgencyBean ab:agencyList)
                       for(int i=0;i<=ordersList.size()-1;i++)
                       { count++;
                       CarbookingBean ab=ordersList.get(i);
                    	   %>
                    	    <tr>
                             <td>
                    	   <%
                    	   
                    	  out.println(ab.getBookingid());
                    	  %>
                    	  </td>
                    	  <td>
                    	    <%
                    	  ...
                    	  <td>
                    	   <%
                    	    out.println(ab.getCustomerid());
                    	    %>
                    	  </td>
                    	  <td>
                    	   <%
                    	    out.println(ab.getPickupdate());
                    	    %>
                    	  </td>
<!--                     	  <td> -->
                    	   <%
//                     	    out.println(ab.getTime());
                    	    %>
<!--                     	  </td> -->
<!--                     	  <td> -->
                    	   <%
//                     	    out.println(ab.getDateandtime());
                    	    %>
<!--                     	  </td> -->
                    	  <td>
                    	   <%
...
<!--                     	   <td id="id1"><a href="#">Complete</a></td> -->
                    <%	

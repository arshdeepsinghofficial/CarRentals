...
<!--                       <th>View</th> -->
                    ...
                    <%
                       ...
                       customerList=(ArrayList<CustomerBean>)request.getAttribute("customerList");
                       int count=0;
                      // out.println("Hello how are you");
                     //  for(AgencyBean ab:agencyList)
                       for(int i=0;i<=customerList.size()-1;i++)
                       { count++;
                         CustomerBean cb=customerList.get(i);
                    	   %>
                    	    <tr>
                             <td>
                    	   <%
                    	   
                    	  out.println(cb.getCustomerid());
                    	  %>
                    	  </td>
                    	  <td>
                    	    <%
                    	  ...
                    	  <td>
                    	   ...
                    	   CustomerBean customer=customerList.get(i);
...
<!--                     	   <td id="id1"><a href="#">View</a></td> -->
                           ...
                           <td id="id1"><a href="CustomerEditController?customerid=<%=cb.getCustomerid()%>">Edit</a></td>
                           
                           
                           
                           
                           
                           <td id="id1"><a href="CustomerDeleteController?customerid=<%=customer.getCustomerid()%>">Delete</a></td>
                    <%	

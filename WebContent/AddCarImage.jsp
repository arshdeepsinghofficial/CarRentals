...
<%--                                 <li class="active"><a href="ToHomeController?usertype=<%="AgencyOwner">Home</a></li>   --%>
...
<!--                                 <li><a href="contact.html">Contact</a></li> -->
    ...
    <section id="lgoin-page-wrap" class="section-padding">
        <div class="container">
            <div id="id6">
              <img src="ImageLoadController?carid=<%=request.getParameter("carid") %>" alt="Image not found" width="450" height="600">
            </div>
            <div id="id7">
            <FORM ENCTYPE="multipart/form-data" ACTION="AddCarImageController?carid=<%=request.getParameter("carid") %>" METHOD=POST>

    ...
    <section id="lgoin-page-wrap" class="section-padding">
        <div class="container">
            ...
            <table >
                   <tr>
                      <th>Agency Id:</th>
                      <td><% out.print(agencyBean.getAgencyid());%></td>
                   </tr>
                    <tr>
                      <th>Owner Id:</th> 
                      <td><%out.print(agencyBean.getOwnerid()); %></td>
                       </tr>
                       <tr>
                      <th>Agency Name</th>
                      <td><%out.print(agencyBean.getAgencyname()) ;%></td>
                       </tr>
                       <tr>
                      <th>Mobile No.</th>
                      <td><% out.print(agencyBean.getMobile());%></td>
                       </tr>
                       <tr>
                      <th>Landline</th>
                      <td><% out.print(agencyBean.getLandline());%></td>
                       </tr>
<!--                        <tr> -->
<!--                       <th>Stateid</th> -->
<%--                       <td><% out.print(agencyBean.getStateid());%></td> --%>
<!--                        </tr> -->
<!--                        <tr> -->
<!--                       <th>Cityid</th> -->
<%--                       <td><%out.print(agencyBean.getCityid()) ;%></td> --%>
<!--                        </tr> -->
                       <tr>
                      <th>Pincode</th>
                      <td><% out.print(agencyBean.getPincode());%></td>
                       </tr>
                       <tr>
                      <th>Addressline1</th>
                      <td><% out.print(agencyBean.getAddressline1());%></td>
                       </tr>
                       <tr>
                      <th>Addressline2</th>
                      <td><% out.print(agencyBean.getAddressline2());%></td>
                       </tr>
                       <tr>
                      <th>Email Id</th>
                      <td><%out.print(agencyBean.getEmailid()); %></td>
                       </tr>
                       <tr>
                      <th>Website URL</th>
                      <td><%out.print(agencyBean.getWebsiteurl()); %></td>
                       </tr>
<!--                        <tr> -->
<!--                       <th>Pic</th> -->
<%--                       <td><% out.print(agencyBean.getPics());%></td> --%>
<!--                        </tr> -->
                       <tr>
                      <th>NumberOfCars</th>
                      <td><%out.print(agencyBean.getNumberofcars()) ;%></td>
                       </tr>
                       <tr>
                      <th>Status</th>
                      <td><% out.print(agencyBean.getStatus());%></td>
                  </tr>

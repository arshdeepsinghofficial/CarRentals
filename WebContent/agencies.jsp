                     ...
                     //  for(AgencyBean ab:agencyList)
                       ...
                       { count++;
                         AgencyBean ab=agencyList.get(i);
                    	  ...
                    	  <td>
                    	    <%
                    	    out.println(ab.getOwnerid());
                    	    %>
                    	  </td>
                    	    <td>
                    	     <%
                    	    out.println(ab.getAgencyname());
                    	    %>
                    	  </td>
                    	  <td>
                    	   <%
                    	    out.println(ab.getEmailid());
                    	    %>
                    	  </td>
                    	  <td>
                    	   <%
                    	    out.println(ab.getMobile());
                    	    %>
                    	  </td>
                    	  <td>
                    	   <%
                    	    out.println(ab.getAddressline1());
                    	    %>
                    	  </td>
                    	  <td>
                    	   <%
                    	    out.println(ab.getWebsiteurl());
                    	    %>
                    	  </td>
                    	  <td>
                    	   <%
                    	   ...
                    	   AgencyBean agency=agencyList.get(i);
...
<!--                     	   <td id="id1"><a href="#">View</a></td> -->
                           ...
                           <td id="id1"><a href="AgencieseditController?agencyid=<%=ab.getAgencyid()%>">Edit</a></td>
                           
                           
                           
                           
                           
                           <td id="id1"><a href="AgenciesDeleteController?agencyid=<%=agency.getAgencyid()%>">Delete</a></td>
                    <%	

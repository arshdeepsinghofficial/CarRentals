...
//     function confirm()
//     {   //("i am buzy");
//     	window.confirm("Do you really want to go here?");
// //     	if (answer !=0)
// //     	{
// //     		location = "login.jsp";
// //     	}
...
<!--                                 <li><a href="car-without-sidebar.html">Cars</a> -->
<!--                                 </li> -->
...
<!--                                 </li>   -->
<!--                                 <li><a id="logout" href="CustomerConfirmLogout.jsp">Logout</a> -->
<!--                                 </li> -->

<!--                                 <li><a  href="#" onclick="confirm(); return false;">Logout</a> -->
<!--                                 </li> -->
...
<!--                                 <li><a href="contact.html">Contact</a></li> -->
    ...
    <section id="slider-area">
        ...
        <div class="single-slide-item overlay">
            <div class="container">
                <div class="row">
                    <div class="col-lg-5" style="padding:100px;">
<!--                         <div class="book-a-car"> -->
<!--                             <form action="IndexCarsController" method="post"> -->
                             
                               <!--== Pick Up Date ==-->
<!--                                 <div class="pick-up-date book-item"> -->
<!--                                     <h4>PICK-UP DATE:</h4> -->
<!--                                     <input type="date" id="startDate" name="pickupdate" placeholder="Pick Up Date" /> -->

<!--                                     <div class="return-car"> -->
<!--                                         <h4>Return DATE:</h4> -->
<!--                                         <input type="date" id="endDate" name="returndate" placeholder="Return Date" /> -->
<!--                                     </div> -->
<!--                                 </div> -->
                                <!--== Pick Up Location ==-->
...
<!--                                       <option selected>Select</option> -->
<!--                                       <option value="1">AMRITSAT</option> -->
...
<!--                                       <option value="5">MARUTI</option> -->
<!--                                       <option value="6">I20</option> -->
<!--                                     </select> -->
                                </div>
                                <!--== Car Choose ==-->

<%--                                 <%int carid=Integer.parseInt(""+request.getAttribute("carid"));  --%>
<!--                                    String carname=(String)request.getAttribute("carname"); -->
<%--                                   request.setAttribute("carid", carid);%> --%>
                                
                                <div>
<%--                                     <input type="text" name="pickupdate" placeholder="Pick Up Date" value=<%=carname %>/> --%>
                                </div>

                                <div class="book-button text-center">
                               <a href="login.jsp" class="map-show" style="padding-left: 50px; padding-right:50px; padding-top: 20px;padding-bottom:20px; font-size: medium;border:2px solid black;">Login/Register</a>
                                </div>
<!--                             </form> -->
<!--                         </div> -->
                    </div>
                        ...
                        <div class="display-table">
                            <div class="display-table-cell">
                                <div class="slider-right-text">
                                 <div id="id1">   <h1 style="text-align: left;">BOOK A CAR TODAY!</h1></div>
                    ...
                    <div class="display-table">
                        <div class="display-table-cell">
                            <div class="about-content">
                                <p>
                                We are Oxcar.com, a trusted car hire online platform. 
                                Oxcar is among the leading car service providers in country. We provide exclusive services to our customers. Customer can choose from the Exclusive collection of cars.</p>

                                <p>Oxcar is dedicated to making car hire online as easy as possible. Oxcar provides you the opportunity to compare and choose the best deal. Customer satisfaction is our key principle.</p>
                                <div class="about-btn">
<!--                                     <a href="IndexCarsController">Book a Car</a> -->
<!--                                     <a href="#">Contact Us</a> -->
                                </div>
                            </div>
                        </div>
...
<!--                            <div class="image">  <img alt="" src="aboutus.jpg" ></div> -->
                    </div>
                </div>
                <!-- About Video End -->
            </div>

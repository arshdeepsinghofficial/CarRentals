...
<!--                     <div class="login-page-content"> -->
                		...
                		<h2 style="text-align: center;">BOOK YOUR CAR</h2><br><br>
             <form action="CarBookingController?carid=<%=Integer.parseInt(""+request.getAttribute("carid")) %>" method="post">
                             
                               <!--== Pick Up Date ==-->
                               <div id="id1">
                                <div >
                                    <h5>PICK-UP DATE:</h5>
                                    <input type="date"  name="pickupdate" placeholder="Pick Up Date" required="required" />

                                    <div >
                                        <h5>Return DATE:</h5>
                                        <input type="date"  name="returndate" placeholder="Return Date" required="required" />
                                    </div>
                                </div>
                                <!--== Pick Up Location ==-->
...
<!--                                     </select> -->
                                         <input type="text" name="state" placeholder="State" required="required" ></input><br>
                                </div>
                                <!--== Pick Up Location ==-->
...
<!--                                     </select> -->
                                         <input type="text" name="city" placeholder="City" required="required" ></input><br>
...
<!--                                     </select> -->
                                         <input type="text" name="location" placeholder="Location" required="required" ></input><br>

                                </div>

                                <%int carid=Integer.parseInt(""+request.getAttribute("carid")); 
                               // out.println("carbooking:carid:"+carid);
                                  String carname=""+request.getAttribute("carname");
                                  request.setAttribute("carid", carid);%>
                                
                                 <h5>CAR-NAME:</h5>
                                <div>
                                    <input type="text" name="carname" placeholder="Car Name" value=<%=carname %> required="required"/>
                                </div>

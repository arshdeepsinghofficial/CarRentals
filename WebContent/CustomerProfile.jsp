...
<!--                  <div class="vr">&nbsp;</div> -->
              ...
              <div id="box">
                 <%if(customerBean.getGender().equals("Male"))
                	 {
                 %>
                    <img src="maleprofile.png" id="image"></img>
                 <%
                	 }
                 else if(customerBean.getGender().equals("Female"))
                 {
                 %>
...
<a href="CustomerProfileEditController?customerid=<%=customerBean.getCustomerid()%>"><div id="id5">Edit Profile</div></a>

                
                    <table>
                      <tr>
                         <th>First Name:</th>
                         <td><%=customerBean.getFname() %></td>
                      </tr>
                      <tr>
                         <th>Last Name:</th>
                         <td><%=customerBean.getLname() %></td>
                      </tr>
                      <tr>
                         <th>Owner Id:</th>
                      ...
                      <tr>
                         <th>Password:</th>
                         <td><%=customerBean.getPassword() %></td>
                      </tr>
                      <tr>
                         <th>Mobile Number:</th>
                         <td><%=customerBean.getMobile() %></td>
                      </tr>
                      <tr>
                         <th>Email Id:</th>
                         <td><%=customerBean.getEmailid() %></td>
                      </tr>
                      <tr>
                         <th>Date Of Birth:</th>
                         <td><%=customerBean.getDateofbirth() %></td>
                      </tr>
                      <tr>
                         <th>Gender:</th>
...
<%--                          <td><%=customerBean.getSecurityquestionid() %></td> --%>
<!--                       </tr> -->
<!--                       <tr> -->
<!--                          <th>Answer:</th> -->
<%--                          <td><%=customerBean.getAnswer() %></td> --%>
<!--                       </tr> -->
                      <tr>
                         <th>Addressline1:</th>
                         <td><%=customerBean.getAddressline1() %></td>
                      </tr>
                      <tr>
                         <th>Addressline2:</th>
                         <td><%=customerBean.getAddressline2() %></td>
                      </tr>
<!--                       <tr> -->
<!--                          <th>Country Id:</th> -->
<%--                          <td><%=customerBean.getCountryid() %></td> --%>
<!--                       </tr> -->
<!--                       <tr> -->
<!--                          <th>State Id:</th> -->
<%--                          <td><%=customerBean.getStateid() %></td> --%>
<!--                       </tr> -->
<!--                       <tr> -->
<!--                          <th>City Id:</th> -->
<%--                          <td><%=customerBean.getCityid() %></td> --%>
<!--                       </tr> -->
<!--                       <tr> -->
<!--                          <th>Pic:</th> -->
<%--                          <td><%=customerBean.getPics() %></td> --%>
<!--                       </tr> -->
                      <tr>
                         <th>Status:</th>
                         <td><%=customerBean.getStatus() %></td>
                      </tr>

...
<!--                                 <li><a href="driver.html">Driver</a></li> -->
                                        ...
                                        <li><a href="AdminConfirmLogout.jsp">Logout</a></li> 
...
<!--                 <div class="col-lg-4 col-md-8 m-auto"> -->
                 ...
                 <a href="agenciesTableController">  <div id="id1">Agencies      </div>  </a>
                
                  <span action="#" method="post">
                 <a href="CarTableController?usertype=<%="Admin" %>">  <div id="id1">Cars          </div>  </a>
                  </span>
                  <span action="#" method="post">
                 <a href="CustomerTableController">  <div id="id1">Customers     </div>  </a>
                  </span>
                 <span action="#" method="post">
                 <a href="AgencyOwnerTableController">  <div id="id1">Agency Owners </div>  </a>
                  </span>
                    
<!--                     <table> -->
<!--                          <tr> -->
<!--                             <td>hdsfjnnnnnnnnnnnnnnnnnnnnn</td>    -->
<!--                             <td>hdskjf</td>    -->
<!--                             <td>dslkjfl</td>    -->
<!--                             <td>jsdflsl;</td>    -->
<!--                             <td></td> -->

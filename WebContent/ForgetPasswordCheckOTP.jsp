...
<%--                                 <li ><a href="ToHomeController?usertype=<%="AgencyOwner" %>">Home</a> --%>
<!--                                 </li>   -->
...
//                 	      int  otp=Integer.parseInt((String)session.getAttribute("otp"));
              ...
              <p style="color:red;">  4 digit OTP has been sent to your registered emailid </p>	 
              <form action="ForgotPasswordCheckOTPController" method="post">
                              
                 
                 <input type="text" name="otp" placeholder="OTP" required="required" pattern="[0-9]{4}" title="Enter 4 digit"></input>

                 
                <div class="log-btn">
		             <button type="submit"><i class="fa fa-sign-in"></i>Verify</button>
			    </div> 
...
<!--                 			<h3>Welcome Back!</h3> -->
<!-- 							<form name="form" action="IndexLoginController" onsubmit="return validate()" method="post"> -->
<!-- 							    <select class="yellow" name="usertype" required="required"> -->
<!-- 									     <option disabled="disabled">Select</option> -->
<!--                                          <option >Admin</option> -->
<!--                                          <option >AgencyOwner</option> -->
<!--                                          <option >Customer</option> -->
<!--                                 </select> -->
<!--                                    <br> -->
                                  
                                  
<!-- 								<div class="username" style="border-spacing:50px 50px;"> -->
...
<!--                 		</div> -->
<!--                 		<div class="create-ac" > -->
<!--                 			<h6><p style="color:blue";>Don't have an account?<a style="font-weight: bold; color:red; font-size: 20px;" href="register.html" >Sign Up</a></p></h6> -->
<!--                 		</div> -->

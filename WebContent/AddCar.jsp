<!DOCTYPE html>
<%@page import="controller.AgencyOwnerHomeCarTableController"%>
...
<!--                     <div class="login-page-content"> -->
            ...
            <div id="id1" >
              <form action="AddCarController?agencyid=<%=agencyid %>" method="post" required="required">
...
<!--                  <input type="text" name="cartypeid" placeholder="cartypeid"></input><br> -->
                 <input type="text" name="carname" placeholder="car name" required="required"></input><br>
                 <select class="yellow" name="cartypeid" required="required">
...
<!--                  <input type="text" name="modelid" placeholder="modelid"></input><br> -->
                 <input type="text" name="carnumber" placeholder="car number" required="required"></input><br>
                 <input type="text" name="carcolor" placeholder="car color" required="required"></input><br>
                 
                 	
                 
<!--                  <input type="text" name="fueltype" placeholder="fueltype"></input><br><br> -->
                 <select class="yellow" name="fueltype" required="required">
									     <option  disabled>Select</option>
                                         <option >Diesel</option>
                                         <option >Petrol</option>
                                         <option >CNG</option>
                 </select>
                 <input type="text" name="priceperkm" placeholder="price per kilometer" required="required" pattern="[0-9]{2}" title="Enter two digits only"></input><br>
                 <input type="text" name="drivercostperday" placeholder="driver cost per day" required="required" pattern="[0-9]{3}" title="Enter three digits only"></input><br>
                 
                 <select class="yellow" required="required">

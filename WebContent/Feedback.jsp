...
<!--                 	<div>	<img src="logout.png"></div> -->
              ...
              <form action="FeedbackController" method="post">
                 ...
                 <input type="emailid" name="emailid" placeholder="emailid" required="required"></input><br><br>
                 <textarea class="yellow" name="message" placeholder="message" required="required"></textarea><br><br>

                 
                <div class="log-btn">
		             <button type="submit"><i class="fa fa-sign-in"></i>Send</button>
			    </div> 
